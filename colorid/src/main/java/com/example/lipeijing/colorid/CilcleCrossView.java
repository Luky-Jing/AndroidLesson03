package com.example.lipeijing.colorid;
...
public class CilcleCrossView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CilcleCrossView(Context context) {
        super(context);
        init();
    }

    public CilcleCrossView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
